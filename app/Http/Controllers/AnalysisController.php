...
class AnalysisController extends Controller
{
    public function index()
    {
        ...
        // $period = Order::betweenDate($startDate, $endDate)->groupBy('id')->selectRaw('id, sum(subtotal) as total,
        // customer_name, status, created_at')->orderBy('created_at')->paginate(50);
